...
description: Complete reference for terminal keyboard shortcuts on macOS, Linux, and Windows. Master Bash, Zsh, and PowerShell navigation, editing, and productivity.
