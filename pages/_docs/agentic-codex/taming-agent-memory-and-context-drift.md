...
permalink: /docs/agentic-codex/taming-agent-memory-and-context-drift/
layout: default
categories:
- Docs
- Certifications
...
---
> Part of the [Agentic Codex reference series](/docs/agentic-codex/) supporting the GH-600 Agentic AI certification track. This article covers **Domain 3** (19% of the exam).
