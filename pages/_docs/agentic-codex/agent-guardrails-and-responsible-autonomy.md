---
title: Agent Guardrails and Responsible Autonomy
description: Design responsible agents using autonomy levels, GitHub guardrails, and human-in-the-loop checkpoints — GH-600 Domain 6 in practice reference.
permalink: /docs/agentic-codex/agent-guardrails-and-responsible-autonomy/
layout: default
categories:
- Docs
- Certifications
...
- autonomy levels
---
> Part of the [Agentic Codex reference series](/docs/agentic-codex/) supporting the GH-600 Agentic AI certification track. This article covers **Domain 6** (9% of the exam).
...
- [Orchestrating Multi-Agent Workflows on GitHub (Domain 5)](/docs/agentic-codex/orchestrating-multi-agent-workflows-on-github/)
