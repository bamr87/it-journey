---
title: Embedding Agents in the SDLC (GH-600 Domain 1)
description: Design an SDLC where GitHub Copilot agents have bounded, observable roles at each stage — from planning through deploy. GH-600 Domain 1 reference.
permalink: /docs/agentic-codex/embedding-agents-in-the-sdlc/
layout: default
categories:
- Docs
- Certifications
...
- agent observability
---
> Part of the [Agentic Codex reference series](/docs/agentic-codex/) supporting the GH-600 Agentic AI certification track. This article covers **Domain 1** (18% of the exam).
...
- [MCP Servers and Agent Tooling in Practice (Domain 2)](/docs/agentic-codex/mcp-servers-and-agent-tooling-in-practice/)
