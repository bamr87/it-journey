...
description: Define machine-verifiable success criteria, debug agent failures, and tune behaviour using GitHub-native signals — GH-600 Domain 4 reference.
permalink: /docs/agentic-codex/evaluating-and-tuning-agents-with-github-signals/
layout: default
categories:
- Docs
- Certifications
...
- root cause analysis
---
> Part of the [Agentic Codex reference series](/docs/agentic-codex/) supporting the GH-600 Agentic AI certification track. This article covers **Domain 4** (19% of the exam).
