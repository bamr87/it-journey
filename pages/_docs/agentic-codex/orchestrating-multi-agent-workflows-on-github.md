...
description: Design and operate multi-agent systems on GitHub Actions — fan-out, correlation, failure recovery, and lifecycle management. GH-600 Domain 5.
permalink: /docs/agentic-codex/orchestrating-multi-agent-workflows-on-github/
layout: default
categories:
- Docs
- Certifications
...
---
> Part of the [Agentic Codex reference series](/docs/agentic-codex/) supporting the GH-600 Agentic AI certification track. This article covers **Domain 5** (17% of the exam).
...
- [Evaluating and Tuning Agents with GitHub Signals (Domain 4)](/docs/agentic-codex/evaluating-and-tuning-agents-with-github-signals/)
- [Agent Guardrails and Responsible Autonomy (Domain 6)](/docs/agentic-codex/agent-guardrails-and-responsible-autonomy/)
