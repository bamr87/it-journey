...
description: Comprehensive instructions for developers and AI agents contributing to the IT-Journey repository, including setup, branching strategies, code standards, and PR workflows.
...
1. **Development Environment Set Up**
   - Follow [Development Environment Setup](/docs/setup/development-environment/)
   - Verify local build works: `bundle exec jekyll serve --config _config_dev.yml`

2. **Familiarity with Project Structure**
   - Read [Repository Structure](https://github.com/bamr87/it-journey/blob/main/docs/architecture/REPOSITORY_STRUCTURE.md)
   - Review [Jekyll Implementation](/docs/jekyll/)

3. **Understanding of Standards**
   - Review [Frontmatter Standards](https://github.com/bamr87/it-journey/blob/main/docs/standards/FRONTMATTER_STANDARDS.md)
   - Read [Content Guidelines](https://github.com/bamr87/it-journey/blob/main/docs/standards/CONTENT_GUIDELINES.md)
...
See the [Frontmatter Standards](https://github.com/bamr87/it-journey/blob/main/docs/standards/FRONTMATTER_STANDARDS.md) for complete details.
...
1. **Read Documentation First**
   - Start with [Repository Structure](https://github.com/bamr87/it-journey/blob/main/docs/architecture/REPOSITORY_STRUCTURE.md)
...
- [Jekyll Implementation](/docs/jekyll/)
- [Frontmatter Standards](https://github.com/bamr87/it-journey/blob/main/docs/standards/FRONTMATTER_STANDARDS.md)
- [Content Guidelines](https://github.com/bamr87/it-journey/blob/main/docs/standards/CONTENT_GUIDELINES.md)
- [Development Environment](https://github.com/bamr87/it-journey/blob/main/docs/setup/DEVELOPMENT_ENVIRONMENT.md)
...
- **Process Questions:** Create discussion in [GitHub Discussions](https://github.com/bamr87/it-journey/discussions)
