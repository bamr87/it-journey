...
description: Master Jekyll static site generation from scratch. Learn installation, the project directory structure, collections, and the build-and-serve workflow to ship fast, secure sites.
