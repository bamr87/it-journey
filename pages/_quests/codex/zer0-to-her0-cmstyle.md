...
excerpt: Build your first AI-powered open-source CMS — VS Code, Git, Jekyll, GitHub Pages, and the automations that do the heavy lifting — in three acts.
...
validation_criteria:
  ...
  - At least one AI-assisted automation (docs, stats, or link checking) running on the site
  ...
  - Can describe what AI should automate (heavy lifting) versus what a human still reviews
---
