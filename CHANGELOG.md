...
- **Quest dependency graph include** — `_includes/content/quest-graph.html`: JS-driven Mermaid flowchart, filterable by level (`{% include content/quest-graph.html level="0001" %}`)
