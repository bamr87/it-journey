...
session:
  ...
  engine_average: 65.0
  engine_counts: "1 pass · 2 warn · 2 fail (1 of the fails is an engine/max-turns abort, not a content verdict)"
  engine_cost_usd: 3.8787
  evidence: walk-evidence.json / walk-evidence.md (sealed by workflow, consumed as-is)
  note: "Report composed from pre-sealed execute-engine evidence; the walker did not re-run the engine."
---
