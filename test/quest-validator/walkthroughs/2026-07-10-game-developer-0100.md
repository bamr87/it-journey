...
session:
  ...
  note: "Report composed from pre-sealed execute-engine evidence; the walker did not re-run the engine. Only quest 1 has machine evidence; quests 2 & 3 are reasoned-only (static read), NOT tested."
---
